...
*/
    ...
    string comando5 = "gnuplot -c run-gnuplot.gp fluxo.png fluxo.dat \"Fluxo do algoritmo (%%)\" " + to_string(num);
    
    system(comando1.c_str());
    system(comando2.c_str());
    system(comando3.c_str());
    system(comando4.c_str());
    system(comando5.c_str());
